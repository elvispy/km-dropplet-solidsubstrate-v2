function res = ProblemConditions_v4(nb_harmonics, deformation_amplitudes, deformation_velocities, ...
       pressure_amplitudes, current_time, dt, center_of_mass, center_of_mass_velocity, contact_angle)
    ...
    res = struct( ...
            ...
            center_of_mass_velocity, "contact_angle", contact_angle);
