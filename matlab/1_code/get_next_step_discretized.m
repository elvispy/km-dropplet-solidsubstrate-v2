function [probable_next_conditions, errortan] = ...
    get_next_step_discretized(previous_conditions, new_nb_contact_points, dt, PROBLEM_CONSTANTS)

    if new_nb_contact_points < 0
        errortan = inf;
        probable_next_conditions = nan;
        return
    else
    ...
    probable_next_conditions.contact_radius = new_nb_contact_points * PROBLEM_CONSTANTS.spatial_step;
