function pressure_amplitudes = kill_pressure_outside_slow(probable_next_conditions, theta_max, PROBLEM_CONSTANTS)
    ...
    for k = 1:N
        ...
        for l = 1:N
            ...
            Cl(k) = Cl(k) + Bl(l) * ( ...
              ...
              + dot(wm, nps((abs(k-l)-1):(k+l-1))) ...
              - wm(1) * (k==l) ); % When k == l, legendre(-1, 1) == 0, as opposed to all other degrees.
        end
    end
