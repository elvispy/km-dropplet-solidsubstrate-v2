...
%     end
    ...
    current_conditions = ProblemConditions_v3( ...
        harmonics_qtt, ...
        initial_amplitudes, ...
        amplitudes_velocities, ...
    ...
    % Aproximating velocities numerically
   ...
   give_dimensions_v3 = @(X) ProblemConditions_v3( ...
       X.nb_harmonics, ...
     ...
     recorded_conditions{1} = give_dimensions_v3(previous_conditions{end});
%     
...
%     mechanical_energy_out = NaN; % TODO: Lab COef of restitution?
    ...
    while ( current_time < final_time) 
        ...
        [current_conditions, errorflag] = get_next_step_v3(previous_conditions, dt, PROBLEM_CONSTANTS);
        ...
        if errorflag == true || abs(theta_from_cylindrical( current_conditions.contact_radius, current_conditions)...
           - theta_from_cylindrical(current_conditions.contact_radius, current_conditions)) > 2*PROBLEM_CONSTANTS.angle_tol
            ...
            % TODO: % Stored data
            recorded_conditions{current_index} = give_dimensions_v3(current_conditions);
